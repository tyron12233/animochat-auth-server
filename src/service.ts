...
export const DISCOVERY_SERVER_URL =
  ...
  "https://animochat-service-discovery-6jj5.onrender.com";
...
export async function startServiceRegistration() {
  ...
  if (process.env.DEBUG === "true") {
    console.log(
      "Service registration is in debug mode, skipping registration."
    );
    return;
  }
...
export default function addStatusEndPoint(app: express.Express) {
